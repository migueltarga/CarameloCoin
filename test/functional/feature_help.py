...
"""Verify that starting caramelocoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start caramelocoin with -h for help text")
        ...
        self.log.info("Start caramelocoin with -version for version information")
