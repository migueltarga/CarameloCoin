...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s caramelocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  caramelocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded caramelocoin transaction") + "\n" +
              "  caramelocoin-tx [options] -create [commands]   " + _("Create hex-encoded caramelocoin transaction") + "\n" +
              "\n";
