...
{
    const char* pszTimestamp = "Vira-Lata Caramelo is live!";
    const CScript genesisOutputScript = CScript() << ParseHex("04620DC5520B60C70139910FB0C2376C52CC85E610AA63B82F1D07BA25CD1DD8109315B1EEBF519D8D168C99DA60FD28AE8BF07FDA45BE5970DAB5B8D65B538E3F") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("1b82506d4084e8ccdd403808b25d6c937ed329aa74d2febce76a0e2e4656225c");
        ...
        consensus.defaultAssumeValid = uint256S("0x1b82506d4084e8ccdd403808b25d6c937ed329aa74d2febce76a0e2e4656225c"); //1441280
        ...
        genesis = CreateGenesisBlock(1616469045, 919212, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1b82506d4084e8ccdd403808b25d6c937ed329aa74d2febce76a0e2e4656225c"));
        assert(genesis.hashMerkleRoot == uint256S("0xbdc92e3efec4351ecca386a91155051e669d6af5e30850878491aa528a4667a5"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.caramelocoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.caramelocointools.com");
        //vSeeds.emplace_back("dnsseed.caramelocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x3a0f2e9de1360ff3023de6443b534432863b3a507b03df6b771c7404fc0b66aa"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 36575, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3a0f2e9de1360ff3023de6443b534432863b3a507b03df6b771c7404fc0b66aa"));
        assert(genesis.hashMerkleRoot == uint256S("0xbdc92e3efec4351ecca386a91155051e669d6af5e30850878491aa528a4667a5"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.caramelocointools.com");
        //vSeeds.emplace_back("seed-b.caramelocoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf47f36b650c9ea0b58acfddee692a79d49622f96de0af86a615ae4e082bef4e2"));
        assert(genesis.hashMerkleRoot == uint256S("0xbdc92e3efec4351ecca386a91155051e669d6af5e30850878491aa528a4667a5"));
