...
#if defined(NDEBUG)
# error "CarameloCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "CarameloCoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("caramelocoin-scriptch");
